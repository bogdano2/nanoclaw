...
For the full architecture details, see [docs/SPEC.md](docs/SPEC.md) or the [documentation site](https://docs.nanoclaw.dev/concepts/architecture).
...
See [CHANGELOG.md](CHANGELOG.md) for breaking changes and migration notes, or the [full release history](https://docs.nanoclaw.dev/changelog) on the documentation site.
